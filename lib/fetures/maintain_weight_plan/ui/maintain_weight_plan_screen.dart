...
class MaintainWeightPlanScreen extends StatefulWidget {
  const MaintainWeightPlanScreen({super.key});

  @override
  State<MaintainWeightPlanScreen> createState() => _MaintainWeightPlanScreenState();
}

class _MaintainWeightPlanScreenState extends State<MaintainWeightPlanScreen> {
  int currentIndex = 0;
